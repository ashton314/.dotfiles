...
(custom-set-faces
 ...
 '(ediff-current-diff-Ancestor ((t (:background "#997888"))))
 '(ediff-current-diff-B ((t (:background "green4" :foreground "color-255"))))
 '(ediff-current-diff-C ((t (:background "#888800"))))
 '(ediff-even-diff-A ((t (:background "#0000ff"))))
 '(ediff-even-diff-Ancestor ((t (:background "gray50"))))
 '(ediff-even-diff-B ((t (:background "magenta4"))))
 '(ediff-even-diff-C ((t (:background "gray60"))))
 '(ediff-fine-diff-A ((t (:background "#ee5656"))))
 '(ediff-fine-diff-B ((t (:background "green3"))))
 '(ediff-fine-diff-C ((t (:background "#afaf00"))))
 '(ediff-odd-diff-A ((t (:background "green4"))))
 '(ediff-odd-diff-B ((t (:background "red"))))
 '(ediff-odd-diff-C ((t (:background "Grey50"))))
